...
<div id="toolbar">
    <div class="pull-left btn-toolbar">
        ...
        <button id="generate_barcodes" class="btn btn-default btn-sm"
            data-href='<?php echo site_url($controller_name."/generate_barcodes"); ?>'>
            <span class="glyphicon glyphicon-barcode">&nbsp;</span>
            <?php echo $this->lang->line("items_generate_barcodes");?>
        </button>

        <!-- ✅ NEW IMPORT BUTTON -->
        <a href="<?php echo site_url('item_kits/import'); ?>" class="btn btn-info btn-sm">
            <span class="glyphicon glyphicon-import"></span>&nbsp;Import Item Kits
        </a>
    </div>
</div>
